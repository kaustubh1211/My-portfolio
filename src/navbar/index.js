    ...
    <div className=" sticky top-0 z-50">
      <nav className="flex items-center justify-between flex-wrap p-6 w-screen ">
        ...
        >
          ...
          <div className=" gap-6 flex mr-6 ">
            <a href="https://www.github.com/kaustubh1211">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-7 "
                fill="currentColor"
            ...
            <a href="https://www.linkedin.com/in/kaustubh-patil-8645b923a/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-7 w-7"
                fill="currentColor"
            ...
            <a href="https://twitter.com/Kaustub1111">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-7"
                fill="currentColor"
